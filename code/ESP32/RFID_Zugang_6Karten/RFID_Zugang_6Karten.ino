/*************************************************************************************************
                                      PROGRAMMINFO
**************************************************************************************************
Funktion: RFID Zugang 6Karten Transponder mit LED-Anzeige
**************************************************************************************************
Version: 21.06.2022
**************************************************************************************************
...
//definieren der Pins  RST & SDA fÃ¼r den ESP32
#define RST_PIN     27
#define SS_PIN      5
...
String rfid_nuids[] = {"e9c3 02a4", "c53acb23", "f73f9339", "539c16 04", "23ae2e 0d", "b9c0b548"};
...
void loop() {
  ...
  if (nuid == rfid_nuids[0]) {
    ...
    else if (nuid == rfid_nuids[3]) {
    Serial.println("Zugang Karte 4");
    led2_status = !led2_status;
    digitalWrite(led2, led2_status ? HIGH : LOW);
  }

    else if (nuid == rfid_nuids[4]) {
    Serial.println("Zugang Karte 5");
    led2_status = !led2_status;
    digitalWrite(led2, led2_status ? HIGH : LOW);
  }

    else if (nuid == rfid_nuids[5]) {
    Serial.println("Zugang Karte 6");
    led2_status = !led2_status;
    digitalWrite(led2, led2_status ? HIGH : LOW);
  }
