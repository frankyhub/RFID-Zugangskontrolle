...
//zulaessige  RFID-ID
String rfids[NUM_RFIDS] = {" A3 11 DD 1D", " 0D 14 6D 38"};
//****************************************************************************************
...
void setup() {
  ...
  digitalWrite(oc_PIN, LOW);
    ...
    Servomotor.write(180);                    // Servomotor auf Schließposition 180 Grad fahren
...
void loop() {
  ...
  if (zugangOk) {
    ...
    Servomotor.write(0);        // Servo in Öffnungsposition 0 Grad fahren 
    ...
    Servomotor.write(180);        // Servo in Öffnungsposition 180 Grad fahren
