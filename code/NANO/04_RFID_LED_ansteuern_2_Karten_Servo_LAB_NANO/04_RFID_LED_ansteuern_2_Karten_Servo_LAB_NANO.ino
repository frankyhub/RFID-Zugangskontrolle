/*************************************************************************************************
                                      PROGRAMMINFO
**************************************************************************************************
Funktion: RFID LED ansteuern, Relais, Servo, 3 Chips
...
//zulaessige  RFID-ID
String rfids[NUM_RFIDS] = {" 43 7D 3F 92", " 73 05 B4 94", " 01 01 01 01"};
//****************************************************************************************
...
void setup() {
  ...
  Serial.println("Das Tuerschloss ist aktiv");
  delay(50);
  ...
  digitalWrite(oc_PIN, LOW);
    ...
    Servomotor.write(0);                    // Servomotor auf Schließposition 0 Grad fahren
...
void loop() {
  ...
  if (zugangOk) {
    ...
    Servomotor.write(90);        // Servo in Öffnungsposition 90 Grad fahren 
    ...
    Servomotor.write(0);        // Servo in Öffnungsposition 90 Grad fahren
